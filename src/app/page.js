...
export default function Home() {
  ...
  const isCurrentSelected = selectedDay?.type === "current";
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-4xl flex-col gap-6 px-4 py-10">
        ...
        {weather && (
          <div className="grid gap-4 md:grid-cols-2">
            <Card
              className={`backdrop-blur bg-white/10 text-white border-white/20 shadow-lg cursor-pointer ${isCurrentSelected ? "border-white/50" : ""}`}
